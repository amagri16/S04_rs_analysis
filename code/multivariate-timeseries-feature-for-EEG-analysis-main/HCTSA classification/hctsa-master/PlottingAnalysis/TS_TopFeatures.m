...
[TS_DataMat,TimeSeries] = FilterLabeledTimeSeries(TS_DataMat,TimeSeries); % only taking the time series samples that have labels 
...
if ismember('cluster',whatPlots)
    ...
    clusterThreshold = 0.5; % threshold at which split into clusters
