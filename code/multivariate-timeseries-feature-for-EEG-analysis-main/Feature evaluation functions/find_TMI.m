function [results,dscrp,idx] = find_MI(y,ch_labels,split_length,results,dscrp)
...
for m = (1:ava_ch_num-1)
    for n = (m+1:1:ava_ch_num)
        ...
        % feature description
        dscrp{end+1} = string(sig1_ch)+'_vs_'+string(sig2_ch)+'_Temporal_Mutual_Information';
        ...
        for k = 1:1:min_sig_size
            ...
            MI = mutual_information_t(sig1_now', sig2_now', 6, 'k', 4);
