...
for m = (1:ava_ch_num-1)
    for n = (m+1:1:ava_ch_num)
        ...
        % feature description
        dscrp{end+1} = string(sig1_ch)+'_to_'+string(sig2_ch)+'_Transfer_Entropy_pink_reduced';
        dscrp{end+1} = string(sig2_ch)+'_to_'+string(sig1_ch)+'_Transfer_Entropy_pink_reduced';
