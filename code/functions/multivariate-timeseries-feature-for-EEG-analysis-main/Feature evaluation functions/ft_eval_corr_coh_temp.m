function sampleObj_coll = ft_eval_corr_coh_temp(sampleObj_coll,filters,filters_PLV,cfg)
...
for i = 1:num_samps %iterating through the number of samples 
    ...
    [ft,ft_dscrp,idx] = MCI_feature_calculation_temp(y,ch_labels,discard_info,Fs,filters,filters_PLV,cfg);        % Core feature evaluation
    samp_now.ft_vec = ft;
    samp_now.ft_idx = idx;
%     if sum(isnan(ft))>0
