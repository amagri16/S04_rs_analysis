...
%% input data Path
inPath='/home/tianyuwei/sleeper_new/master/feature_extraction/Feature evaluation functions/High-Order-interactions-master/dataset/timeseries/';%Path files
...
for patient=1:Npatients
        dataPatient=load(sprintf('%sts_m20_p%.3d.txt',inPath,patient)); %Load the data per subject. For example ts_20_young_001.txt,...,ts_20_young_026.txt
