function [dscrp, features] = Regional_Connectivity(dscrp, features)
...
field_names = fieldnames(ft_all_single);  
for i = 1:length(field_names)
    field_name = field_names{i};
    ft_mat = ft_all_single.(field_name); 
...
field_names = fieldnames(ft_all_undirected); 
for i = 1:length(field_names)
    field_name = field_names{i};
    ft_mat = ft_all_undirected.(field_name); 
    avg_ft_mat = mean(ft_mat,2);
    if ~isempty(avg_ft_mat)
        ft_mat_all = [ft_mat_all avg_ft_mat];
        ft_dscrp{end+1,1} = field_name;
...
field_names = fieldnames(ft_all_directed); 
for i = 1:length(field_names)
    field_name = field_names{i};
    ft_mat = ft_all_directed.(field_name); 
    avg_ft_mat = mean(ft_mat,2);
    if ~isempty(avg_ft_mat)
        ft_mat_all = [ft_mat_all avg_ft_mat];
        ft_dscrp{end+1,1} = field_name;
